...
pub struct AppState {
    ...
    pub conversation_preview: Option<crate::app::conversation::ConversationPreview>,
    pub copy_mode: Option<CopyModeState>,
    pub workspace_scroll: usize,
    pub agent_panel_scroll: usize,
    /// TUI-only focus within Navigate mode; never persisted as runtime/session state.
    pub navigate_agents: bool,
